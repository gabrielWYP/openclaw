...
# Install Docker CLI for socket access
RUN apt-get update && \
...
#
# Docker socket access: add node user to host's docker group
USER root
ARG DOCKER_GID=999
...
# Install openclaw globally so the binary is available in PATH
